"""Configuracion central del pipeline ATP."""
...
# --- Modelado ------------------------------------------------------------
SEMILLA = 42  # asignacion aleatoria jugador A / jugador B: reproducible
MIN_HISTORIAL_DEFECTO = 10  # partidos previos minimos por jugador
